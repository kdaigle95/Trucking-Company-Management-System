...
public class IncomingShippingFactory {
    ...
    public IncomingShipping createIncomingShipping(int orderID, String sourceCompany, String address, String city, String state, int zip, int truckID, java.util.Date departureDate, java.util.Date estArrival, String arrivalConf, int driverID, String paymentConf){
